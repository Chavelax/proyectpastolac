                ...
                <tr>
                  ...
                  <td width="25%">
                    <center>
                      ...
                      <a class="btn red btn-outline sbold derecha" title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold" href='?admin=MateriaPri&eliminar&codigo=<?php echo $id ?>'><i class=' fa fa-trash'></i></a>
            ...
            <div class="portlet-body">
              <div class="table-scrollable">
                <table class="table table-striped table-hover">
                  <thead>
                    <tr>
                      <form role="form" action="?admin=MateriaPri&crear=crear" method="post" enctype="multipart/form-data">
                        <th>Nombre</th>
                        <th></th>
                  </thead>
                  <tbody>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td width="50%">
                        <center>
                          <input class="form-control" required type="number" step="any" name="costoo" min="0" />
                      </td>
                      <td width="50%">
                        <center>
        ...
        <div class="editinplace row">
          <div class="table-scrollable">
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  <form role="form" action="?admin=listado" method="post" enctype="multipart/form-data">
                    <th>Nombre</th>
                    <th></th>
              </thead>
              <tbody>
              ...
              while ($fila = $bd->mostrar_registros()) { ?>
                <?php if (($fila->tipe) == "Materia Prima") { ?>
                  <tr>
                    ...
                    <td width="25%">
                      <center>
                        <a class="btn red btn-outline sbold derecha" title="Eliminar" class="btn red btn-outline sbold" href='?admin=eliL&id_no=<?php echo $fila->id_no ?>'><i class=' fa fa-trash'></i></a>
                      </center>
                    </td>
                  </tr>
              <?php
