...
<div class="row">
  <div class="col-md-12">
    ...
    <a style=" margin-left: 10px;" class="btn red btn-outline sbold " title="Actualizar tabla" data-toggle="modal" href="?admin=salidaM"> <i class="fa fa-refresh" aria-hidden="true"></i> </a>
                ...
                <tr>
                  ...
                  <td width="25%" class="hidden-print noprin">
                    <center>
                      ...
                      <a class="btn red btn-outline sbold " title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold" href='?admin=salidaM&eliminar&codigo=<?php echo $id ?>'><i class=' fa fa-trash'></i></a>
                  ...
                  <thead>
                    <tr>
                      <div id="register_form">
                        <form role="form" action="?admin=salidaM&crear=crear" method="post" enctype="multipart/form-data">
