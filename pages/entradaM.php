...
<div class="row">
  <div class="col-md-12">
    ...
    <a style=" margin-left: 10px;" class="btn red btn-outline sbold " title="Actualizar tabla" data-toggle="modal" href="?mod=entradaM"> <i class="fa fa-refresh" aria-hidden="true"></i> </a>
                  ...
                  <thead>
                    <tr>
                      <div id="register_form">
                        <form role="form" action="?mod=entradaM&crear=crear" method="post" enctype="multipart/form-data">
                          <th>Materia Prima </th>
                          <th>Cantidad </th>
                          <th></th>
                  </thead>
