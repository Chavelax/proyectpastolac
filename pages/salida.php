...
if (isset($_GET['crear'])) {
  ...
  if ($service == "") {
    ...
    if ($grantotal < 0) {
      ...
      $sql = "INSERT INTO `salida` (`id_salida`, `id_service_id_salida`, `fecha_salida`, `id_user_id_salida`, `cantida_salida`, `motivo_salida`, `tipo_ser`) VALUES (NULL, '$service', '$resultado', '$user', '$cantida', '$motivo', 'Producto Elaborado')";
      $bd->consulta($sql);
...
<div class="row">
  <div class="col-md-12">
    ...
    <a style=" margin-left: 10px;" class="btn red btn-outline sbold " title="Actualizar tabla" data-toggle="modal" href="?mod=salida"> <i class="fa fa-refresh" aria-hidden="true"></i> </a>

    <div class="portlet light ">
      <div class="portlet-title">
        <div class="caption font-dark">
          <i class="icon-arrow-up font-dark"></i>
          <span class="caption-subject bold uppercase">Registros de Salidas de Productos</span>
        ...
        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
          <thead>
            <tr>
              ...
              <th class="min-phone-l">Productos</th>
          ...
          <tbody>
            ...
            while ($fila1 = $bd->mostrar_registros()) {
              if (($fila1->tipo_ser) == "Producto Elaborado") {
                ...
                <tr>
                  ...
                  <td width="25%" class="hidden-print noprin">
                    <center>
                      ...
                      <a class="btn red btn-outline sbold " title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold" href='?mod=salida&eliminar&codigo=<?php echo $id ?>'><i class=' fa fa-trash'></i></a>
  ...
  <div id="login-overlay" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-eye"></i>&nbsp; Stock de Productos.</h4>
        </h2>
      </div>
      <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
      <div class="modal-body">
