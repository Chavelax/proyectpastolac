      ...
      for ($x = 0; $x < count($_FILES["fondo"]["name"]); $x++) {
        ...
        if ($size == 0) {
          $sql = "INSERT INTO `service`
                                              (`id_service`, `name_service`, `costo`, `tipo_producto`, `info_service`,`imagen`) VALUES
                                               (NULL, '$nombress', '$precio', '$tipopro', '$descripcion','img-no.jpg');";
          $bd->consulta($sql);
        ...
        } else if ($size > 1024 * 1024) // 1024*1024 = 1 MB
        {
          ...
          $sql = "INSERT INTO `service`
          (`id_service`, `name_service`, `costo`, `tipo_producto`, `info_service`,`imagen`) VALUES
          (NULL, '$nombress', '$precio', '$tipopro', '$descripcion','$name3');";
          $bd->consulta($sql);
...
<div class="row">
  <div class="col-md-12">
    ...
    <a style=" margin-left: 10px;" class="btn red btn-outline sbold " title="Actualizar tabla" data-toggle="modal" href="?mod=MateriaPri"> <i class="fa fa-refresh" aria-hidden="true"></i> </a>
    <div class="portlet light ">
      ...
      <div class="portlet-body">
        ...
        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
          ...
          <tbody>
            <?php
          $consulta1 = "SELECT tipo_producto, MAX(cantida) cantida FROM service GROUP by tipo_producto";
          $bd->consulta($consulta1);
          while ($fila1 = $bd->mostrar_registros()) { 
             if (($fila1->tipo_producto) == "Materia Prima") { 
              $jeje=$fila1->cantida;
          }}
          $consulta2 = "SELECT tipo_producto, MIN(cantida) cantida FROM service GROUP by tipo_producto";
          $bd->consulta($consulta2);
          while ($fila2 = $bd->mostrar_registros()) { 
             if (($fila2->tipo_producto) == "Materia Prima") { 
              $jejee=$fila2->cantida;
          }}
            ...
            while ($fila = $bd->mostrar_registros()) { ?>
              <?php if (($fila->tipo_producto) == "Materia Prima") { ?>
                <tr>
                  ...
                  <?php if ($jeje==($fila->cantida)){ ?>
                  <td width="20%" style="background-color:#C0FF52" > <?php echo $fila->cantida; ?> 
                  <i class="fa fa-level-up" aria-hidden="true"> Stock</i>
                  </td>
                  <?php } else if ($jejee==($fila->cantida)) {?>
                    <td width="20%" style="background-color:#FF5252" > <?php echo $fila->cantida; ?> 
                    <i class="fa fa-level-down" aria-hidden="true"> Stock minimo</i>
                    </td>
                  <?php } else {?>
                  ...
                  <td width="25%">
                    <center>
                      ...
                      <a class="btn red btn-outline sbold derecha" title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold" href='?mod=MateriaPri&eliminar&codigo=<?php echo $id ?>'><i class=' fa fa-trash'></i></a>
    ...
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        ...
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-eye"></i>&nbsp; Registrar Materia prima.</h4>
        </h2>
      </div>
            ...
            <div class="portlet-body">
              <div class="table-scrollable">
                <table class="table table-striped table-hover">
                  <thead>
                    <tr>
                      <form role="form" action="?mod=MateriaPri&crear=crear" method="post" enctype="multipart/form-data">
                        <th>Nombre</th>
                        <th></th>
                  </thead>
                  <tbody>
                    <tr>
                      <td width="50%">
                        <center>
                          ...
                          <select required required name="nombre" class="form-control">
                            <?php
                            $consulta = "SELECT * FROM listado ";
                            $bd->consulta($consulta);
                            while ($fila = $bd->mostrar_registros()) {
                              if (($fila->tipe) == "Materia Prima") { ?>
                                <option><?php echo $fila->name_no; ?></option>
                            <?php }
                            } ?>
                          </select>
                      </td>
                      <td>
                        <a style=" margin-left: 10px;" title="Registrar listado" class="btn blue btn-outline sbold " data-toggle="modal" href="#nuevoname">Nuevo </a>
                      </td>
                  ...
                  <tbody>
                    <input class="hidden" type="text" name="tipopro" value="Materia Prima" />
                    <tr>
                      <td width="50%">
                        <center>
                          <input class="form-control" required type="number" step="any" name="costoo" min="1" />
                      </td>
                      <td width="50%">
                        <center>
...
<!--modal listado -->
<div class="modal fade" id="nuevoname" tabindex="-1" role="basic" aria-hidden="true">
  <div id="login-overlay" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-eye"></i>&nbsp; Agregar Nombre</h4>
        </h2>
      </div>
      <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
      <div class="modal-body">
        <div class="editinplace row">
          <div class="table-scrollable">
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  <form role="form" action="?mod=listado" method="post" enctype="multipart/form-data">
                    <th>Nombre</th>
                    <th></th>
              </thead>
              <tbody>
                <input type="hidden" name="tipor" value="Materia Prima">
                <tr>
                  <td width="50%">
                    <center>
                      <input required type="text" required name="namer" required class="form-control">
                  </td>
                  <td>

                    <button type="submit" class="btn blue btn-outline sbold" name="lugarguardar" value="Guardar">Registrar</button>
                    <a class="btn red btn-outline sbold " data-toggle="modal" href="#verpro">Ver Listado</a>
                  </td>
...
<!--ver listado -->
<div class="modal fade" id="verpro" tabindex="-1" role="basic" aria-hidden="true">
  <div id="login-overlay" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-eye"></i>&nbsp; ver lista Nombre</h4>
        </h2>
      </div>
      <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
      <div class="modal-body">
        <div class="editinplace row">
          <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
            <thead>
              <tr>
                <th class="min-phone-l">Nombre</th>
                <th class="min-phone-l">Opcion</th>
              </tr>
            </thead>
            <tbody>
              <?php
              ...
              $bd->consulta($consulta);
              while ($fila = $bd->mostrar_registros()) { ?>
                <?php if (($fila->tipe) == "Materia Prima") { ?>
                  <tr>
                    <td width="5%"><?php echo $fila->name_no; ?></td>
                    <td width="25%">
                      <center>
                        <a class="btn red btn-outline sbold derecha" title="Eliminar" class="btn red btn-outline sbold" href='?mod=eliL&id_no=<?php echo $fila->id_no ?>'><i class=' fa fa-trash'></i></a>
                      </center>
                    </td>
                  </tr>
              <?php
  ...
  <div id="login-overlay" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-edit"></i>&nbsp; Editar Materia Prima.</h4>
        </h2>
      </div>
      <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
      <div class="modal-body">
