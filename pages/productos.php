...
<div class="row">
  <div class="col-md-12">
    ...
    <a style=" margin-left: 10px;" class="btn red btn-outline sbold " title="Actualizar tabla" data-toggle="modal" href="?mod=productos"> <i class="fa fa-refresh" aria-hidden="true"></i> </a>
        ...
        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
          ...
          <tbody>
            ...
            while ($fila1 = $bd->mostrar_registros()) {
              if (($fila1->tipo_producto) == "Producto Elaborado") {
                $jeje = $fila1->cantida;
              }
            }
            ...
            while ($fila2 = $bd->mostrar_registros()) {
              if (($fila2->tipo_producto) == "Producto Elaborado") {
                $jejee = $fila2->cantida;
              }
            }
                ...
                <tr>
                  ...
                  <td width="25%">
                    <center>
                      ...
                      <a class="btn red btn-outline sbold derecha" title="Eliminar" onclick='if(confirmDel() == false){return false;}' class="btn red btn-outline sbold" href='?mod=productos&eliminar&codigo=<?php echo $id ?>'><i class=' fa fa-trash'></i></a>
    ...
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        ...
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-eye"></i>&nbsp; Registrar Nuevo producto.</h4>
        </h2>
      </div>
            ...
            <div class="portlet-body">
              <div class="table-scrollable">
                <table class="table table-striped table-hover">
                  <thead>
                    <tr>
                      <form role="form" action="?mod=productos&crear=crear" method="post" enctype="multipart/form-data">
                        <th>Nombre</th>
                        <th></th>
                  </thead>
                  <tbody>
                      ...
                      <td width="50%">
                        <center>
                          ...
                          <select required required name="nombre" class="form-control">
                            ...
                            $bd->consulta($consulta);
                            while ($fila = $bd->mostrar_registros()) {
                              if (($fila->tipe) == "Producto Elaborado") { ?>
                  ...
                  <tbody>
                    <tr>
                      <input class="hidden" required type="text" name="tipopro" value="Producto Elaborado" />
                      <td width="50%">
                        <center>
                          <input class="form-control" required type="number" step="any" name="precio" min="1" />
                      </td>
                      <td width="50%">
                        <center>
        ...
        <div class="editinplace row">
          <div class="table-scrollable">
            <table class="table table-striped table-hover">
              <thead>
                <tr>
                  <form role="form" action="?mod=listado2" method="post" enctype="multipart/form-data">
                    <th>Nombre</th>
                    <th></th>
              </thead>
              <tbody>
                <input type="hidden" name="tipor" value="Producto Elaborado">
                <tr>
                  <td width="50%">
                    <center>
        ...
        <div class="editinplace row">
          <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
            ...
            <tbody>
              ...
              $bd->consulta($consulta);
              while ($fila = $bd->mostrar_registros()) { ?>
                <?php if (($fila->tipe) == "Producto Elaborado") { ?>
                  <tr>
                    <td width="5%"><?php echo $fila->name_no; ?></td>
                    <td width="25%">
                      <center>
                        <a class="btn red btn-outline sbold derecha" title="Eliminar" class="btn red btn-outline sbold" href='?mod=eliL2&id_no=<?php echo $fila->id_no ?>'><i class=' fa fa-trash'></i></a>
                      </center>
                    </td>
                  </tr>
              <?php
  ...
  <div id="login-overlay" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="border-bottom: 4px solid #2e77bc; background-color: #fff; color: #111;">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
        <h2 class="modal-title" id="myModalLabel" style="font-size: 9pt;">
          <h4><i class="fa fa-eye"></i>&nbsp; Consultar Producto</h4>
        </h2>
      </div>
      <div style="margin-top: 1px; background-color: #2e77bc; height: 1px; width: 100%;"></div>
      <div class="modal-body">
